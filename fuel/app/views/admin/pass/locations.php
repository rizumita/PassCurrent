...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><?php echo \Fuel\Core\Form::input('latitude', '', array('class' => 'span3', 'placeholder' => 'Number')); ?></td>
        <td><?php echo \Fuel\Core\Form::input('longitude', '', array('class' => 'span3', 'placeholder' => 'Number')); ?></td>
        <td><?php echo \Fuel\Core\Form::input('altitude', '', array('class' => 'span3', 'placeholder' => 'Number, allow no value')); ?></td>
        <td><?php echo \Fuel\Core\Form::input('relevant_text', '', array('class' => 'span3', 'placeholder' => 'Allow no value')); ?></td>
