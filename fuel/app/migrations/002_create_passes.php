...
class Create_passes
{
	public function up()
	{
		\DBUtil::create_table('passes', array(
            ...
            'background' => array('constraint' => 255, 'type' => 'varchar', 'null' => true),
            'background2x' => array('constraint' => 255, 'type' => 'varchar', 'null' => true),
            'footer' => array('constraint' => 255, 'type' => 'varchar', 'null' => true),
            'footer2x' => array('constraint' => 255, 'type' => 'varchar', 'null' => true),
            ...
            'thumbnail' => array('constraint' => 255, 'type' => 'varchar', 'null' => true),
            'thumbnail2x' => array('constraint' => 255, 'type' => 'varchar', 'null' => true),
            ...
            'cert' => array('constraint' => 1023, 'type' => 'varchar', 'null' => true),
